...
func (sr *sqlProductRepo) CreateProduct(ctx context.Context, product *model.Product) (*response.CreateResponse, error) {
	...
	row := stmt.QueryRowContext(ctx, &product.ProductName, &product.ProductAmount, &product.ProductPrice, &product.ProductUserCreated)
...
func (sr *sqlProductRepo) GetProduct(ctx context.Context, id string) (*response.GenericResponse, error) {
	...
	if err = row.Scan(&product.ProductID, &product.ProductName, &product.ProductAmount, &product.ProductPrice, &product.ProductUserCreated, &product.ProductDateCreated, &product.ProductUserModify, &product.ProductDateModify); err != nil {
...
func (sr *sqlProductRepo) GetProducts(ctx context.Context) (*response.GenericResponse, error) {
	...
	for row.Next() {
		...
		err = row.Scan(&product.ProductID, &product.ProductName, &product.ProductAmount, &product.ProductPrice, &product.ProductUserCreated, &product.ProductDateCreated, &product.ProductUserModify, &product.ProductDateModify)
